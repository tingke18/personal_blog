...
export default {
    ...
    created() {
        this.selectNotCheckCommentCount()
    },
    computed: {
        username() {
        ...
        userAvatar(){
            let userAvatar = localStorage.getItem('ms_avatar');
            return userAvatar ? userAvatar : this.avatar;
        }
    },
    methods: {
        selectNotCheckCommentCount(){
            commentApi.selectNotCheckCommentCount().then(res=>{
                if (res.success){
